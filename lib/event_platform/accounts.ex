defmodule EventPlatform.Accounts do
  @moduledoc """
  ...
  alias EventPlatform.Accounts.{User, UserToken, UserNotifier}
  ...
  See `EventPlatform.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `EventPlatform.Accounts.User.password_changeset/3` for a list of supported options.
