defmodule EventPlatformWeb.UserLive.Registration do
  use EventPlatformWeb, :live_view

  alias EventPlatform.Accounts
  alias EventPlatform.Accounts.User
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: EventPlatformWeb.UserAuth.signed_in_path(socket))}
  end
